    ...
    for j in range(epoch):
        ...
        for training_element in training_elements:            
            ...
            for i in range(1, len(similar_texts)):
                ...
                # Combine tokenized strings
                combined_tokenized_string = torch.cat((tokenized_stringA, tokenized_stringB), dim=1).to(device)
                ...
                logits_before_sep = logits[:, :tokenized_stringA.size(1), :]
